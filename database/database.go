...
func (db *DB) RunQueryIncrementally(ctx context.Context, query string, batchSize int, f func(*sql.Rows) error, params ...any) (err error) {
	...
	return db.Transact(ctx, sql.LevelDefault, func(ctx context.Context, tx *DB) error {
...
func (db *DB) Transact(ctx context.Context, iso sql.IsolationLevel, f func(context.Context, *DB) error) (err error) {
...
func (db *DB) transactWithRetry(ctx context.Context, opts *sql.TxOptions, f func(context.Context, *DB) error) (err error) {
...
func (db *DB) transact(ctx context.Context, opts *sql.TxOptions, f func(context.Context, *DB) error) (err error) {
	if db.InTransaction() {
	...
	dbtx.conn = conn
	dbtx.opts = *opts
	if err := f(ctx, dbtx); err != nil {
		return fmt.Errorf("f(tx): %w", err)
	}
	return nil
}
